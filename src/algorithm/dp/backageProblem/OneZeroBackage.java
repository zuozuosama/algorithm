package algorithm.dp.backageProblem;
 ...
 * 8
 */
public class OneZeroBackage {
    public static void main(String[] args) throws Exception {
        OneZeroBackage ozb = new OneZeroBackage();
        ozb.oneZeroBackage1();
    }

    public void oneZeroBackage2(){
        // 读入数据的代码
    ...
    public int oneZeroBackage(int N, int V, int[] v, int[] w) {
        int[][] dp = new int[N + 1][V + 1];
        dp[0][0] = 0;
        for (int i = 1; i < N; i++) {
            for (int j = 0; j < V; j++) {
